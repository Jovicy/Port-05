...
// icons
import  { FaGithub, FaYoutube, FaDribble, FaDatabase} from 'react-icons/fa';
// type animation
      ...
      <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
        ...
        <div className='flex-1 text-center font-secondary lg:text-left'>
          ...
          <motion.div variants={fadeIn('up', 0.4)} initial="hidden" whileInView={'show'} viewport={{once: false, amount: 0.7}} className='mb-6 text-[36px] lg:text-[60px] font-secondary font-semibold uppercase leading-[1]'>
            ...
            <TypeAnimation sequence={['Developer', 2000, 'Youtuber', 2000, 'FreeLancer']} speed={50} className='text-accent' wrapper='span' repeat={Infinity}/>
          </motion.div>
          <motion.p variants={fadeIn('up', 0.5)} initial="hidden" whileInView={'show'} viewport={{once: false, amount: 0.7}} className='mb-8 max-w-lg mv-auto lg:mx-0'>Lorem imotion.psum edje eivejofv j ve vje jve jfv en vje vje jv eov ej cjo vanv jv hi v ejv j vevkeivne venivejvejv  nvejv ev e ve veve m ve ibf eije9rhurhurhf uhe8urh euu</motion.p>
