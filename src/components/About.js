      ...
      <div className='container mx-auto'>
        <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
          ...
          <motion.div variants={fadeIn('left', 0.5)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='flex-1'>
            ...
            <p className='mb-6'>Lorem cnwucwb weuwbeo wc cwbuwbewj vobvjv;ierbuber virv  revooie jo je fwjnefiwef efjwenfwnjef wefjwefjwefj jfowebfjw fjenifj fwjfboj fjefowebf nf efbefhg wjrvb uf vhrvkneruv erf4irv</p>
            {/* stats */}
